...
describe("SignInForm Component", () => {
  ...
  it("verifies code and enables next step", async () => {
    ...
    const verifyButton = screen.getByRole("button", { name: "Verify my Email" });
  ...
  it("does not verify if code is empty", async () => {
    ...
    const verifyButton = await screen.findByRole("button", { name: "Verify my Email" });
    fireEvent.click(verifyButton);
  ...
  it("shows error message if verification code is incorrect", async () => {
    ...
    await userEvent.type(screen.getByPlaceholderText("Enter the code here"), "wrongcode");
