        ...
        const steps = [
          {
            ...
            content: (
              <ul className="text-sm text-[#4F7A6A] list-disc pl-5 space-y-2">
                ...
                <li>
                  <strong>Waste:</strong> Estimate project waste. <em>Tip: Multiply weekly waste by 52 to get the annual figure.</em>
                </li>
              </ul>
            ),
          },
          {
            ...
            content: (
              <p className="text-sm text-[#4F7A6A]">
                Please enter project-related procurement expenses. Add a new line for each category. For reference, this section is taken directly from the Higher Education Supply Chain Emission Tool (HESCET) created by the Higher Education Procurement Association (HEPA).{' '}
                <a href="https://www.hepa.ac.uk/" target="_blank" rel="noopener noreferrer" className="text-[#385A4F] underline">Visit HEPA Website</a>
              </p>
            ),
          },
          {
            ...
            content: (
              <p className="text-sm text-[#4F7A6A]">
                View a comprehensive summary and visual representations of your project's annual carbon footprint. This section includes detailed charts and graphs, allowing you to easily interpret your data. Use the results to identify key emission sources and explore opportunities for reducing your carbon footprint.
              </p>
            ),
          },
          {
            ...
            content: (
              <ul className="text-sm text-[#4F7A6A] list-disc pl-5 space-y-2">
                <li>
                  <strong>"Next" Button:</strong> Click to save progress on each page.
                </li>
                <li>
                  <strong>Final Submission:</strong> Review all data before submitting.
                </li>
                <li>
                  Need help?{' '}
                  <a
        ...
        return (
          ...
          >
            ...
            <div className="flex flex-col items-center mb-6 space-y-2">
              ...
              {/* Main Heading */}
              <h2 className="text-2xl md:text-3xl font-bold text-center" style={{ color: primaryGreen }}>
            ...
            <p className="text-center text-[#4F7A6A] mb-8 max-w-3xl mx-auto text-sm">
              Welcome to the Academic Carbon Footprint Calculator. This tool is designed to help you estimate and better understand the annual carbon footprint of your research activities. By following the steps below, you will be guided through the process of data entry, procurement details, and the interpretation of results to support informed sustainability decisions.
            </p>
            ...
            <div className="flex flex-col gap-10 mb-12 px-4">
              {steps.map(({ title, content }, index) => (
                <div
                  ...
                  style={{ boxShadow: cardShadow, borderRadius: "30px", height: "100%" }}
                >
                  <div
                  ...
                  >
                    <h3 className="text-xs font-medium text-left" style={{ color: primaryGreen }}>
                      {title}
                    </h3>
                  </div>
            ...
            <div className="d-flex justify-content-end fixed bottom-0 end-0 p-3" style={{ zIndex: 10 }}>
              <button
                type="button"
